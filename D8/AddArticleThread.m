...
@implementation AddArticleThread
...
-(void)start:(NSString*)uid :(NSString *)title:(NSString *)body :(UIImage *)image
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",  [Configs sharedInstance].API_URL, [Configs sharedInstance].ADD_ARTICLE]];
    ...
    // [request setValue:[NSString stringWithFormat:@"%@=%@", [preferences objectForKey:_SESSION_NAME], [preferences objectForKey:_SESSION_ID]] forHTTPHeaderField:@"X-CSRF-Token"];
    
   //  NSLog(@"%@", [NSString stringWithFormat:@"%@=%@", [preferences objectForKey:_SESSION_NAME], [preferences objectForKey:_SESSION_ID]]);
    ...
    // [request setHTTPBody:[postData dataUsingEncoding:NSUTF8StringEncoding]];
     ...
     NSDictionary* dict = @{ @"uid":uid, @"title": title,
