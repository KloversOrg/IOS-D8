...
@implementation DeleteArticleThread
...
-(void)start:(NSString *)nid
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",  [Configs sharedInstance].API_URL, [Configs sharedInstance].DELETE_ARTICLE]];
