//
//  DevicePushNotificationThread.m
//  D8
//
//  Created by System Administrator on 7/1/2559 BE.
//  Copyright © 2559 KLover. All rights reserved.
//

#import "DevicePushNotificationThread.h"

//@implementation DevicePushNotificationThread
//
//@end
...
-(void)start:(NSString *)nid
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",  [Configs sharedInstance].API_URL, [Configs sharedInstance].DEVICE_PUSH_NOTIFICATION]];
    ...
    NSDictionary* dict = @{@"uuid_device": nid};
    NSError* error;
