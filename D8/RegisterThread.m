...
-(void)start:(NSString *)username:(NSString *)password :(NSString *)email;
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",  [Configs sharedInstance].API_URL, [Configs sharedInstance].USER_REGISTER ]];
